...
form?.addEventListener("submit", async (event) => {
    ...
    if (!input || !sectionTempoInfo)
        return; //se não existir nada, retorna nada
    ...
    try {
        ...
        const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${localizacao}&appid=57fe410a1d0d8b795c0dd1131e7ec8b3&lang=pt_br&units=metric`);
        //retorna um json
